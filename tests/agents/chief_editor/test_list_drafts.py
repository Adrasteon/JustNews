...
def test_list_drafts(monkeypatch):
    ...
    fake_system = {"persistence": {"synthesized_article_storage": "synthesized_articles"}}
    monkeypatch.setattr('config.core.get_config', lambda: SimpleNamespace(system=fake_system))
