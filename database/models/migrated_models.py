...
class MigratedDatabaseService:
    ...
    def _connect_databases(self):
        ...
        try:
            # If the embedding model and dimensions are provided in the
            # configuration prefer to scope the collection name to avoid
            # mixing incompatible embedding dimensions in the same Chroma
            # collection. If embedding info isn't present, fall back to the
            # CHROMADB_MODEL_SCOPED_COLLECTION env var for legacy behavior.
