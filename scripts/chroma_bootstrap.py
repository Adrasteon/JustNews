...
Usage:
    PYTHONPATH=. conda run -n justnews-py312 python scripts/chroma_bootstrap.py --host HOST --port PORT --tenant TENANT --collection COLLECTION
...
def main():
    ...
    print(f"🔧 Bootstrapping ChromaDB at {host}:{port} (tenant={tenant}, collection={collection})")
