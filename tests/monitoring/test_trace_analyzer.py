...
from monitoring.core.trace_analyzer import AnomalyType, TraceAnalyzer  # noqa: E402
from monitoring.core.trace_collector import TraceData, TraceSpan  # noqa: E402
from monitoring.core.trace_processor import TraceAnalysis  # noqa: E402
...
def test_update_baselines_and_trends():
    ...
    assert (
        "global:duration" in analyzer.performance_baselines
        or "svcA:latency" in analyzer.performance_baselines
    )
