...
This hybrid architecture plugs the current gaps—GPU telemetry correlation, distributed traces, kernel log
visibility—while preserving Prometheus for alerts. Switching or augmenting backends later only requires adjusting
collector exporters because instrumentation already speaks OpenTelemetry.
