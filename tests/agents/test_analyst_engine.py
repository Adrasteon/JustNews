...
class TestAnalystEngineInitialization:
    ...
    def test_init_spacy_failure(self, mock_import_spacy):
        ...
        with patch('agents.analyst.analyst_engine._import_transformers_pipeline', return_value=(None, None)), \
             patch('agents.analyst.analyst_engine.AnalystEngine._initialize_gpu_analyst'):
...
class TestEntityExtraction:
    ...
    def test_extract_entities_transformer_fallback(self):
        ...
        with patch('agents.analyst.analyst_engine._import_spacy', return_value=(None, None)), \
            ...
            mock_pipeline.return_value = [
                {"word": "Apple", "entity_group": "ORG", "start": 0, "end": 5, "score": 0.95},
                {"word": "John Smith", "entity_group": "PERSON", "start": 10, "end": 20, "score": 0.88}
            ]
    ...
    def test_extract_entities_pattern_fallback(self):
        ...
        with patch('agents.analyst.analyst_engine._import_spacy', return_value=(None, None)), \
            ...
            result = engine.extract_entities("Apple announced that John Smith joined the company.")
...
class TestKeyMetricsExtraction:
    ...
    def test_extract_key_metrics_financial(self):
        ...
        with patch('agents.analyst.analyst_engine._import_spacy', return_value=(None, None)), \
            ...
            text = "The company reported $2.5 billion in revenue, up 15% from last year."
            ...
            financial_metrics = [m for m in result["metrics"] if m.get("type") == "currency"]
    ...
    def test_extract_key_metrics_temporal(self):
        ...
        with patch('agents.analyst.analyst_engine._import_spacy', return_value=(None, None)), \
            ...
            text = "The event happened on January 15, 2024, and will continue next week."
            result = engine.extract_key_metrics(text)
...
class TestSentimentAnalysis:
    ...
    def test_analyze_sentiment_neutral(self):
        ...
        with patch('agents.analyst.analyst_engine._import_spacy', return_value=(None, None)), \
            ...
            result = engine.analyze_sentiment("The product exists and functions as expected.")
...
class TestBiasDetection:
    ...
    def test_detect_bias_gpu_success(self):
        ...
        with patch('agents.analyst.analyst_engine._import_spacy', return_value=(None, None)), \
            ...
            result = engine.detect_bias("This opinion is absolutely the best and only correct view!")
    ...
    def test_detect_bias_heuristic_fallback(self):
        ...
        with patch('agents.analyst.analyst_engine._import_spacy', return_value=(None, None)), \
            ...
            result = engine.detect_bias("Liberals are always wrong and conservatives are always right!")
    ...
    def test_detect_bias_low_bias(self):
        ...
        with patch('agents.analyst.analyst_engine._import_spacy', return_value=(None, None)), \
            ...
            result = engine.detect_bias("The facts show that the data supports this conclusion.")
...
class TestContentTrendsAnalysis:
    ...
    def test_analyze_content_trends_topic_analysis(self):
        ...
        with patch('agents.analyst.analyst_engine._import_spacy', return_value=(None, None)), \
            ...
            texts = ["Technology is advancing rapidly.", "New technology changes everything."]
            result = engine.analyze_content_trends(texts)
...
class TestCombinedAnalysis:
    ...
    def test_analyze_sentiment_and_bias_combined(self):
        ...
        with patch('agents.analyst.analyst_engine._import_spacy', return_value=(None, None)), \
            ...
            result = engine.analyze_sentiment_and_bias("This is a balanced and factual article.")
