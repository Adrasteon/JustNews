...
## 2025-11-01 - BBC link_preview_only (max_articles=100)
 Environment: justnews-py312, Crawl4AI 0.7.4, Playwright Chromium refreshed 2025-11-01.
 Command: `PYTHONPATH=. conda run -n justnews-py312 python - <<'PY' ... max_articles=100` after updating concurrency to 1, max links to 120.
